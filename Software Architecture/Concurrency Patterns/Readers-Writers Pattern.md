The Reader-Writer pattern is a design pattern that allows multiple readers to read from a shared resource in parallel but requires exclusive access for a writer. 
